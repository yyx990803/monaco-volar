...
import { c as commonjsGlobal, p as pathBrowserify, l as lib, _ as __vitePreload } from "./index-45f5c94f.js";
var dist = {};
var main$1 = {};
var registry = {};
var grammar = {};
...
async function dispatchGrammars(scopeName) {
  switch (scopeName) {
    case "source.vue":
      return {
        format: "json",
        content: await __vitePreload(() => import("./vue.tmLanguage-8997f825.js"), true ? [] : void 0)
      };
    case "source.ts":
      return {
        format: "json",
        content: await __vitePreload(() => import("./TypeScript.tmLanguage-93080ffe.js"), true ? [] : void 0)
      };
    case "source.tsx":
      return {
        format: "json",
        content: await __vitePreload(() => import("./TypeScriptReact.tmLanguage-38952f9c.js"), true ? [] : void 0)
      };
    case "source.js":
      return {
        format: "json",
        content: await __vitePreload(() => import("./JavaScript.tmLanguage-256d3551.js"), true ? [] : void 0)
      };
    case "source.js.jsx":
    case "source.jsx":
      return {
        format: "json",
        content: await __vitePreload(() => import("./JavaScriptReact.tmLanguage-721ad52a.js"), true ? [] : void 0)
      };
    case "text.html.basic":
      return {
        format: "json",
        content: await __vitePreload(() => import("./html.tmLanguage-f40fd721.js"), true ? [] : void 0)
      };
    case "source.css":
      return {
        format: "json",
        content: await __vitePreload(() => import("./css.tmLanguage-a0083200.js"), true ? [] : void 0)
      };
    case "source.stylus":
      return {
        format: "json",
        content: await __vitePreload(() => import("./stylus.tmLanguage-20bc4888.js"), true ? [] : void 0)
      };
    case "source.markdown":
      return {
        format: "json",
        content: await __vitePreload(() => import("./markdown.tmLanguage-28d5acb0.js"), true ? [] : void 0)
      };
    default:
      return {
        format: "json",
